...
public class StudentDao implements StudentDaoInterface{
    ...
    public boolean insertStudent(Student s) {
        ...
        try{
            ...
            String query="insert into student_info(sname,clgname,city,percentage) value(?,?,?,?)";
    ...
    public boolean delete(int roll) {
        ...
        try{
            Connection con=DBConnection.createConnection();
            String query="delete from student_info where rollnum="+roll;
            PreparedStatement pst=con.prepareStatement(query);
            pst.executeUpdate();
            flag=true;
    ...
    public boolean update(int roll, String update, int ch, Student s) {
        ...
        try{
            if(choice==1){
                Connection con=DBConnection.createConnection();
                String query="update student_info set sname=? where rollnum=?";
    ...
    public boolean showStudentById(int roll) {
        ...
        try{
            ...
            Connection con=DBConnection.createConnection();
            String query="select * from student_info where rollnum="+roll;
            Statement stmt=con.createStatement();
            ResultSet rs=stmt.executeQuery(query);
            while(rs.next()){
                System.out.println("RollNumber: "+rs.getInt(1)+"\n" +
